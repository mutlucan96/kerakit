...
(() => {
  ...
  document.getElementById('taskbar-attention')
  ...
  document.getElementById('taskbar-badge-remove').addEventListener('click', () => {
    send('badge', 'remove');
  });
  // eslint-disable-next-line max-len
  document.getElementById('taskbar-progress30').addEventListener('click', () => {
    send('progress', 30);
  });
  // eslint-disable-next-line max-len
  document.getElementById('taskbar-progress70').addEventListener('click', () => {
    send('progress', 70);
  });
